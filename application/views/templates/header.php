    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                ### ## Langkah 5: Buat View untuk Menu Navigasi

                Buat file-file berikut di dalam `application/views/templates/`.

                #### a. Navigasi Admin
                File `application/views/templates/nav_admin.php`:
                ```php
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        ...
                        <span>Setup Unit</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="fas fa-fw fa-users"></i>
                        <span>Setup Guru/Karyawan</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="fas fa-fw fa-user-graduate"></i>
                        <span>Setup Siswa</span></a>
                </li>
                <hr class="sidebar-divider">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        ...
                        <span>Tanggapan & Monitoring</span></a>
                </li>