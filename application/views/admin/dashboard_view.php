                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade active show" id="kt_chart_widget_11_tab_content_3"
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <!--end::Statistics-->
                                            <!--begin::Description-->
                                            <span class="fs-6 fw-semibold text-gray-400">Deliveries in
                                                30 Days</span>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Statistics-->
                            ...
                            <div class="card-header pt-7">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">Delivery
                                        Tracking</span>
                                    <span class="text-gray-400 mt-1 fw-semibold fs-6">56 deliveries in
                                        progress</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                        ...
                                        <div class="m-0">
                                            ...
                                            <div class="timeline ms-n1">
                                                ...
                                                <div class="timeline-item align-items-center mb-4">
                                                    <!--begin::Timeline line-->
                                                    <div class="timeline-line w-20px mt-12 mb-n14">
                                                    </div>
                                                    <!--end::Timeline line-->
                                                    <!--begin::Timeline icon-->
                                                    ...
                                                    <div class="timeline-content m-0">
                                                        ...
                                                        <!--end::Title-->
                                                        <!--begin::Title-->
                                                        <span class="fw-semibold text-gray-400">6391
                                                ...
                                                <div class="timeline-item align-items-center">
                                                    ...
                                                    <div class="timeline-content m-0">
                                                        ...
                                                        <!--end::Title-->
                                                        <!--begin::Title-->
                                                        <span class="fw-semibold text-gray-400">2464
                                            ...
                                            <div class="timeline ms-n1">
                                                ...
                                                <div class="timeline-item align-items-center mb-4">
                                                    ...
                                                    <div class="timeline-content m-0">
                                                        ...
                                                        <!--end::Title-->
                                                        <!--begin::Title-->
                                                        <span class="fw-semibold text-gray-400">3891
                                                ...
                                                <div class="timeline-item align-items-center">
                                                    ...
                                                    <div class="timeline-content m-0">
                                                        ...
                                                        <!--end::Title-->
                                                        <!--begin::Title-->
                                                        <span class="fw-semibold text-gray-400">8502
                                            ...
                                            <div class="timeline ms-n1">
                                                ...
                                                <div class="timeline-item align-items-center mb-4">
                                                    ...
                                                    <div class="timeline-content m-0">
                                                        ...
                                                        <!--end::Title-->
                                                        <!--begin::Title-->
                                                        <span class="fw-semibold text-gray-400">3517 W.
                                                ...
                                                <div class="timeline-item align-items-center">
                                                    ...
                                                    <div class="timeline-content m-0">
                                                        ...
                                                        <!--end::Title-->
                                                        <!--begin::Title-->
                                                        <span class="fw-semibold text-gray-400">Total
                    ...
                    <div class="col-xl-8 mb-5 mb-xl-10">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7 mb-3">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">Deliveries by
                                        Category</span>
                            ...
                            <div class="card-body d-flex flex-column justify-content-between pb-5 px-0">
                                ...
                                <div class="tab-content ps-4 pe-6">
                                    ...
                                    <div class="tab-pane fade active show" id="kt_charts_widget_32_tab_content_1">
                                        <!--begin::Chart-->
                                        <div id="kt_charts_widget_32_chart_1" class="min-h-auto" style="height: 375px">
                                        </div>
                                        <!--end::Chart-->
                                    </div>
                                    <!--end::Tap pane-->
                    ...
                    <div class="col-xl-4 mb-xl-10">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7">
                                ...
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                    <a href="../../demo23/dist/apps/ecommerce/catalog/add-product.html"
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <a href="../../demo23/dist/apps/ecommerce/sales/details.html"
                                                class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Fjallraven</a>
                                            <span class="text-gray-400 fw-semibold d-block fs-7">Item:
                                                #XDG-6437</span>
                                        </div>
                                        <!--end::Section-->
                                    </div>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">Lading
                                        Companies</span>
                                    <span class="text-gray-400 mt-1 fw-semibold fs-6">8k social
                                        visitors</span>
                                </h3>
