            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">Data Manajemen</li>
                    </ul>
                </div>
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="<?= site_url('admin/manajemen/import') ?>" class="btn btn-sm btn-light-primary ms-3">
                        <i class="ki-duotone ki-cloud-upload fs-2"></i>Import dari Excel
                    </a>
                    <a href="<?= site_url('admin/manajemen/create'); ?>" class="btn btn-sm fw-bold btn-primary">
                        <i class="ki-outline ki-plus fs-2"></i>Tambah Manajemen
                    </a>
                </div>
            </div>
        </div>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                <?php foreach ($user_list as $user): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge badge-light-primary"><?= htmlspecialchars($user->keterangan); ?></span>
                                        </td>
                                        <td class="text-end">
                                            <a href="#"
