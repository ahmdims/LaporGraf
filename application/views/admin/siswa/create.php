            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">Tambah Siswa</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="card card-flush py-4">
                    <div class="card-body pt-5">
                        <?= form_open_multipart('admin/siswa/store'); ?>

                        <div class="mb-10 fv-row">
                            <label class="required form-label">ID</label>
                            <input type="text" name="user_id" class="form-control mb-2" placeholder="Masukkan ID"
                                required />
                        </div>
